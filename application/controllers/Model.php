...
class Model extends CI_Controller {
    ...
    function getModel()
    {
        $output = $this->ModelModel->getModel();
    ...
    public function remove()
    {
        if ($this->input->method() == 'post') {
            ...
            $action = $this->ModelModel->remove($id);
            if ($action) {
                $response = [
                    'status' => 'success',
                    'title' => 'Berhasil!',
    ...
    public function create()
    {
        ...
        $result = $this->ModelModel->create($data);
    ...
    function getModelById()
    {
        if ($this->input->method() == 'post') {
            ...
            $action = $this->ModelModel->getModelById($id)->row();
            $response = $action;
    ...
    public function update()
    {
        ...
        if(isset($_FILES['foto'])) { 
            ...
            $nama_foto = $Model->foto;
            $file_path = '../upload/Model/img/'. $nama_foto;
        ...
        $result = $this->ModelModel->update($id, $data);
