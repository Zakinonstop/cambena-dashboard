...
class JenisPakaian extends CI_Controller {
    ...
    {
        $output = $this->JenisPakaianModel->getJenisPakaian();
    ...
    public function remove()
    {
        if ($this->input->method() == 'post') {
            ...
            $action = $this->JenisPakaianModel->remove($id);
            if ($action) {
                $response = [
                    'status' => 'success',
                    'title' => 'Berhasil!',
    ...
    public function create()
    {
        ...
        $result = $this->JenisPakaianModel->create($data);
    ...
    function getJenisPakaianById()
    {
        if ($this->input->method() == 'post') {
            $id = $this->input->post('id');

            $action = $this->JenisPakaianModel->getJenisPakaianById($id)->row();
            $response = $action;
    ...
    public function update()
    {
        ...
        if(isset($_FILES['foto'])) { 
            ...
            $JenisPakaian = $this->JenisPakaianModel->find($id);  
            $nama_foto = $JenisPakaian->foto;
            $file_path = '../upload/JenisPakaian/img/'. $nama_foto;
            ...
            if($file['error'] === UPLOAD_ERR_OK) { //cek file ok
                ...
                $uploadDir = '../upload/JenisPakaian/img/';
        ...
        $result = $this->JenisPakaianModel->update($id, $data);
